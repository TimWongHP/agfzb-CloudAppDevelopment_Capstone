...
def analyze_review_sentiments(review):
    api_key = "1VDAcXXv7-P0JXxIZ2Nq5lKvr3Dfr4efU9IHjGdHcY4Q"
    url = "https://api.au-syd.natural-language-understanding.watson.cloud.ibm.com/instances/db4db5dc-3229-4e3d-b4a2-f43ea920e0cb"
    ...
    try:
        ...
        print("Review too short for sentiment analysis. Assigning default sentiment value")
